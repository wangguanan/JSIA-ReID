...
import torchvision
import math
from tools import rgb2gray, norm, denorm
...
##################################################################################
# Modality-Invariant(Set-Level) Encoder and Instance-Level Encoder
##################################################################################
...
class Encoder(nn.Module):
    ...
    def __init__(self, class_num):
        ...
        # cnn backbone
        # here we use block1 as modality-invariant (set-level) encoder
        # and block2-4 as instance-level encoder
